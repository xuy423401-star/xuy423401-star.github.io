...
const allWorks: PhotographyWork[] = [
  ...
  { slug: 'photo-32-dark-window', number: '32', title: '落日里的四个人', englishTitle: 'Four at Sunset', chapter: 'daily', ...image('IMG_20250706_210309.jpg', 3072, 4096), alt: '落日时分，一家四口在河道中央的平台上休息和玩耍，父母分坐两侧，两个孩子位于中间，四个人与晚霞倒映在水面。', short: '父母坐在两边，两个孩子留在中间，一家四口把河道中央的小平台变成了落日里的客厅。', note: '落日把天空和水面染成橙红、紫蓝交叠的色彩，河道中央的平台横向穿过画面。一家四口以黑色剪影出现：爸爸和妈妈守在两侧，两个孩子在中间玩耍、停留，四个人的倒影随水面轻轻拉长。人物很小，家庭关系却成为整张照片最清晰的结构。作品记录的不是壮观风景，而是一个普通傍晚如何因为陪伴而变得完整——河道是他们短暂的游乐场，平台是临时的客厅，落日则替这段休息时间点亮了背景。' },
