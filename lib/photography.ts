...
const allWorks: PhotographyWork[] = [
  ...
  { slug: 'photo-39-river-line', number: '39', title: '河流的白线', englishTitle: 'White Line of the River', chapter: 'water', ...image('IMG_20260818_094403.png', 1086, 1448), alt: '深色地面上蜿蜒的白色河流或纹理。', short: '一条白线穿过黑色，像大地留下的呼吸。', note: '深色背景衬出蜿蜒白线，画面接近抽象。它可以是水、盐、裂缝或光，重要的不是辨认，而是感受一条细线如何让沉默拥有方向。' },
